...
![**Results of a PLS analysis based on the relationship between daily chill (quantified with the Dynamic Model) and heat (quantified with the GDH model) accumulation and bloom of Chinese chestnut (Castanea mollissima) in Beijing, China (Guo et al., 2014a)**](images/PLS_chill_force_chestnut.png)

![**Results of a PLS analysis based on the relationship between daily chill (quantified with the Dynamic Model) and heat (quantified with the GDH model) accumulation and bloom of jujube (Ziziphus jujuba) in Beijing, China (Guo et al., 2014a)**](images/PLS_chill_force_jujube.png)

![**Results of a PLS analysis based on the relationship between daily chill (quantified with the Dynamic Model) and heat (quantified with the GDH model) accumulation and bloom of mountain peach (Prunus davidiana) in Beijing, China (Guo et al., 2014b)**](images/PLS_chill_force_mountain_peach_Beijing.png)

![**Results of a PLS analysis based on the relationship between daily chill (quantified with the Dynamic Model) and heat (quantified with the GDH model) accumulation and bloom of mountain peach (Prunus davidiana) in Beijing, China (Guo et al., 2014b)**](images/PLS_chill_force_mountain_peach_Beijing.png)

![**Results of a PLS analysis based on the relationship between daily chill (quantified with the Dynamic Model) and heat (quantified with the GDH model) accumulation and bloom of apricot (Prunus armeniaca) in Beijing, China (Guo et al., 2014b)**](images/PLS_chill_force_apricot_Beijing.png)
...
![**Results of a PLS analysis of the relationship between chill (in Chill Portions) and heat (in GDH) and bloom dates of apple in Shaanxi, China (Guo et al., 2019)**](images/PLS_chill_force_apple_China.png)
...
![**Results of a PLS analysis of bloom dates of cherries ‘Schneiders späte Knorpelkirsche’ in Klein-Altendorf, Germany, based on chill (in Chill Portions) and heat (in GDH) accumulation (Luedeling et al., 2013a)**](images/PLS_chill_force_cherry_KA.png)
...
![**Results of a PLS analysis of apricot bloom in the southern UK, based on chill accumulation (in Chill Portions) and heat accumulation (in GDH) (Martı́nez-Lüscher et al., 2017)**](images/PLS_chill_force_apricot_UK.png)
...
![**Results of a PLS analysis of flowering dates of grapevine (cv. ‘Riesling Italico’) in Mandicevac, Croatia. Chill was quantified with the Dynamic Model, heat with the Growing Degree Hours Model (Martı́nez-Lüscher et al., 2016)**](images/PLS_chill_force_grapevine_Croatia.png)
...
![**Results of a PLS analysis of leaf emergence dates of walnuts (cv. ‘Payne’) in Davis, California. Chill was quantified with the Dynamic Model, heat with the Growing Degree Hours Model (Luedeling et al., 2013a)**](images/PLS_chill_force_walnut_CA.png)
...
![**PLS results for almond cultivars near Sfax, Tunisia - part 1 (Benmoussa et al., 2017a)**](images/PLS_chill_force_almonds1_Tunisia.png)

![**PLS results for almond cultivars near Sfax, Tunisia - part 2 (Benmoussa et al., 2017a)**](images/PLS_chill_force_almonds2_Tunisia.png)

![**PLS results for almond cultivars near Sfax, Tunisia - part 3 (Benmoussa et al., 2017a)**](images/PLS_chill_force_almonds3_Tunisia.png)
...
![**PLS results for pistachios near Sfax, Tunisia (Benmoussa et al., 2017b)**](images/PLS_chill_force_pistachio_Tunisia.png)
